...
(cl:defmethod cl:initialize-instance :after ((m <FibonacciGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FibonacciGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot3_gazebo-msg:<FibonacciGoal> is deprecated: use turtlebot3_gazebo-msg:FibonacciGoal instead.")))

(cl:ensure-generic-function 'order-val :lambda-list '(m))
(cl:defmethod order-val ((m <FibonacciGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot3_gazebo-msg:order-val is deprecated.  Use turtlebot3_gazebo-msg:order instead.")
  (order m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FibonacciGoal>)))
  ...
  "turtlebot3_gazebo/FibonacciGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FibonacciGoal)))
  "Returns string type for a message object of type 'FibonacciGoal"
  "turtlebot3_gazebo/FibonacciGoal")
