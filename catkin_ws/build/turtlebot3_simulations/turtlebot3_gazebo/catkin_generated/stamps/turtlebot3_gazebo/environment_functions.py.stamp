...
def create_scene():  
    ...
    spawn_model('blue_cube', '/home/dank/.gazebo/models/objects/blue_cube.sdf', [2,0,1] ) 		
...
def randomizer():
    ...
    #Brute force through all rooms: a ball spawns somewhere inside the chosen room, between the specific x and y values of the room
    for i in range (20):
        if room_number == 1:
